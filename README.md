> # ARCHIVED. The code moved to [`op-adapters`](https://github.com/observer-protocol/op-adapters/tree/main/packages/ows-op-verify).
>
> **Your installed tarball still verifies and nothing was unpublished.** Versions of
> `@observer-protocol/ows-op-verify` published before 2026-08-05 name *this* repository in their `repository` field
